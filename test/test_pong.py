...
class MenuBar(Frame):
    ...
    def __init__(self, boss=None):
        ...
        me1 = Menu(fileMenu)
        me1.add_command(label='Opciók', underline=0, command=boss.options)
        me1.add_command(label='Újrainditás', underline=0, command=boss.reset)
        me1.add_command(label='Vége', underline=0, command=boss.quit)
        ...
        me1 = Menu(helpMenu)
        me1.add_command(label='A játék elve', underline=0, command=boss.principe)
...
class JatekTabla(Frame):
    ...
    def clic(self, event):
        ...
        print(row, col, event.y, event.x, self.side)
